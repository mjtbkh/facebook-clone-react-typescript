...
const Login:React.FC = () => {
    ...
    return(
        <div className="container w-10/12 py-16 mx-auto bg-gray-100 flex flex-row">
            <div id="saved-accounts" className="w-2/3">
                ...
                <div className="flex flex-row mt-4">
                    ...
                    <div className="w-40 h-48 bg-gray-200 rounded-lg mr-8 relative overflow-hidden shadow">
                        <div>
                            <div className="bg-blue-500 text-white text-6xl font-bold w-16 h-16 rounded-full text-center ml-12 mt-12 shadow-inner cursor-pointer">+</div>
                        </div>
            ...
            <div id="login-form" className="w-1/3 bg-white rounded-lg p-4 my-4 text-center shadow-md">
                ...
                >
                    <input className="bg-white rounded-sm border-2 border-gray-100 px-1 py-4 mb-4" type="text" placeholder="Username" name="username"
                           onChange={(e: any) => getUser(e.target.value)}
                    />
                ...
                <hr />
                <button className="w-1/2 bg-green-500 rounded-lg text-white font-bold my-4 p-3 flex mx-auto text-center" >Create new account</button>
